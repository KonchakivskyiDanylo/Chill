...
export const GAMES: GameMeta[] = [
  ...
  },
  {
    ...
    icon: '🤝',
    rules: [
      'A secret player is picked. Their most frequent tournament teammates are revealed one at a time.',
      'Only tournament matches count towards the teammate ranking.',
      'Easy: teammates come fewest → most matches, with the match count shown.',
      'Hard: same order, match counts hidden.',
      'Random: random order, match counts hidden.',
      'You may guess after every clue. The game ends on a correct guess or after all 10 clues.',
    ],

...
export const ROSTER: RosterSeed[] = [
  ...
  { id: 'mero', name: 'Mero', realName: 'Diego Campos', country: 'US', region: 'NAE', born: '2004-02-14', earnings: 1430000, team: 'Sentinels', pr: 1960, tier: 1, first: 'C2S2', last: 'C7S2', fncsWins: 2, signature: [['ewc-2025', 1]], partners: ['acorn', 'ajerss'] },
  { id: 'acorn', name: 'Acorn', country: 'US', region: 'NAE', born: '2005-06-10', earnings: 780000, team: 'Sentinels', pr: 1480, tier: 2, first: 'C3S1', last: 'C7S2', fncsWins: 1, signature: [['ewc-2026', 1]], partners: ['mero'] },
  ...
  { id: 'slackes', name: 'Slackes', country: 'US', region: 'NAE', born: '2003-04-08', earnings: 510000, pr: 1120, tier: 3, first: 'C2S3', last: 'C6S2', status: 'inactive' },
  ...
  { id: 'reverse2k', name: 'Reverse2k', country: 'US', region: 'NAE', born: '2002-10-05', earnings: 820000, pr: 1280, tier: 2, first: 'C2S1', last: 'C5S4', status: 'inactive' },
  { id: 'megga', name: 'Megga', country: 'US', region: 'NAE', born: '2003-05-11', earnings: 610000, team: 'FaZe Clan', pr: 1200, tier: 3, first: 'C2S2', last: 'C6S1', status: 'inactive' },
  { id: 'jamper', name: 'Jamper', country: 'US', region: 'NAE', born: '2003-02-17', earnings: 560000, pr: 1150, tier: 3, first: 'C2S1', last: 'C5S2', partners: ['bugha'], status: 'inactive' },
  ...
  { id: 'unknown', name: 'Unknown', realName: 'Ronaldo Maach', country: 'US', region: 'NAE', born: '2003-11-23', earnings: 780000, pr: 1260, tier: 2, first: 'C2S1', last: 'C5S1', status: 'inactive' },
  { id: 'tfue', name: 'Tfue', realName: 'Turner Tenney', country: 'US', region: 'NAE', born: '1998-01-02', earnings: 650000, pr: 720, tier: 2, first: 'C2S1', last: 'C2S4', status: 'inactive', signature: [['wc-2019-duo', 3]] },
  ...
  { id: 'sway', name: 'Sway', country: 'US', region: 'NAE', born: '2004-06-28', earnings: 420000, team: 'FaZe Clan', pr: 900, tier: 3, first: 'C2S2', last: 'C5S3', status: 'inactive' },
  ...
  // ---------------------------------------------------------------- NA West
  { id: 'psalm', name: 'Psalm', realName: 'Harrison Chang', country: 'US', region: 'NAW', born: '1995-11-13', earnings: 1920000, pr: 1180, tier: 1, first: 'C2S1', last: 'C4S2', status: 'inactive', signature: [['wc-2019-solo', 2], ['dh-anaheim-2020', 1]] },
  { id: 'epikwhale', name: 'EpikWhale', realName: 'Shane Cotton', country: 'US', region: 'NAW', born: '2002-07-09', earnings: 1560000, team: 'NRG', pr: 1840, tier: 1, first: 'C2S1', last: 'C7S2', fncsWins: 2, signature: [['wc-2019-solo', 3], ['fncs-gc-2024', 1]] },
  ...
  { id: 'ceice', name: 'Ceice', country: 'US', region: 'NAW', born: '2002-06-18', earnings: 560000, team: 'FaZe Clan', pr: 1160, tier: 2, first: 'C2S1', last: 'C5S4', status: 'inactive' },
  { id: 'riversan', name: 'Riversan', country: 'US', region: 'NAW', born: '2003-09-02', earnings: 520000, pr: 1120, tier: 3, first: 'C2S3', last: 'C6S2', status: 'inactive' },
  ...
  // ----------------------------------------------------------------- Europe
  { id: 'mrsavage', name: 'MrSavage', realName: 'Martin Foss Andersen', country: 'NO', region: 'EU', born: '2004-08-14', earnings: 1240000, team: '100 Thieves', pr: 2020, tier: 1, first: 'C2S1', last: 'C7S2', fncsWins: 2, signature: [['fncs-invitational-2021', 1]], partners: ['benjyfishy'] },
  ...
  { id: 'mongraal', name: 'Mongraal', realName: 'Kyle Jackson', country: 'GB', region: 'EU', born: '2004-09-29', earnings: 760000, team: 'FaZe Clan', pr: 1280, tier: 2, first: 'C2S1', last: 'C5S4', partners: ['mitr0'], status: 'inactive' },
  { id: 'mitr0', name: 'Mitr0', realName: 'Dmitri Van de Vrie', country: 'NL', region: 'EU', born: '2003-05-02', earnings: 700000, pr: 1240, tier: 2, first: 'C2S1', last: 'C5S2', partners: ['mongraal'], status: 'inactive' },
  ...
  { id: 'th0mashd', name: 'Th0masHD', country: 'DK', region: 'EU', born: '2004-02-08', earnings: 940000, team: 'Team Falcons', pr: 1780, tier: 1, first: 'C2S4', last: 'C7S2', fncsWins: 2, signature: [['gamers8-2023', 1]] },
  { id: 'anas', name: 'Anas', country: 'FR', region: 'EU', born: '2005-04-17', earnings: 830000, team: 'Team Falcons', pr: 1660, tier: 1, first: 'C3S2', last: 'C7S2', fncsWins: 2, signature: [['fncs-gc-2023', 1]], partners: ['vadeal'] },
  ...
  { id: 'veno', name: 'Veno', country: 'DE', region: 'EU', born: '2004-01-27', earnings: 720000, team: 'Wave Esports', pr: 1460, tier: 2, first: 'C2S5', last: 'C7S2', fncsWins: 1, signature: [['fncs-gc-2025', 1]] },
  ...
  { id: 'wolfiez', name: 'Wolfiez', realName: 'Jaden Ashman', country: 'GB', region: 'EU', born: '2003-10-24', earnings: 1540000, pr: 1240, tier: 1, first: 'C2S1', last: 'C4S4', status: 'inactive', signature: [['wc-2019-duo', 2]], partners: ['rojo'] },
  { id: 'aqua', name: 'Aqua', realName: 'David Wang', country: 'AT', region: 'EU', born: '2002-05-08', earnings: 1860000, pr: 1460, tier: 1, first: 'C2S1', last: 'C4S4', signature: [['wc-2019-duo', 1]], partners: ['nyhrox'], status: 'inactive' },
  { id: 'nyhrox', name: 'Nyhrox', realName: 'Emil Bergquist Pedersen', country: 'NO', region: 'EU', born: '2003-01-31', earnings: 1620000, pr: 1380, tier: 1, first: 'C2S1', last: 'C4S2', signature: [['wc-2019-duo', 1]], partners: ['aqua'], status: 'inactive' },
  { id: 'rojo', name: 'Rojo', country: 'NO', region: 'EU', born: '2003-06-07', earnings: 1180000, pr: 1300, tier: 1, first: 'C2S1', last: 'C6S2', signature: [['wc-2019-duo', 2]], partners: ['wolfiez'], status: 'inactive' },
